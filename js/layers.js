...
start: new ExpantaNum(0),
    ...
    effectDescription() { 
return `(基于物质/反物质的最小值)<br>宇宙开始扩张...请勿让正反物质小于1,否则会导致宇宙塌缩.<br>标注c的资源要点击才能生成，且只能同时生成一个<br>第一次到60平衡点会解锁新层级<br>如果在低于60平衡点坍缩，则固定+0.25混沌点`
 },
    clickables: {
        11: {
            display() {
...
player.p.points = player.p.points.add(0.25)
 ...
 if ((player.b.m.lt(1) || player.b.am.lt(1))&&player.b.points.gte(60)) {
        ...
        player.b.points = player.b.points.max(layers.b.bgain())
